# What is the goal?
The main goal of SIMNOS is to simulate the SSH connection and behavior of a network device in a lightweight and easy way. Here are some of the goals of SIMNOS:
